# -*- coding: utf-8 -*-
"""224W_FinalProj_HyperGCN_JAY'S FINAL EDITED COPY.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1gRRtuQgltkHnqZoxuQlb0nDVq8DhaeFm

# **CS224W - Final Project - Hypergraph GCNs**
...
(Initialize node embeddings) $\rightarrow$ (Simple Graph Convolutions: GCN) $\rightarrow$ (Hypergraph Convolutions: GCN) $\rightarrow$ (Final node embeddings) $\rightarrow$ (Link Prediction Layer)
...
class HyperGCN(nn.Module):
    def __init__(self, node_number, dropout, hidden_dim=256):
        """
        Hyper Graph Graph Conv Nettwork
        """
        ...
        self.gcn1 = GCN(hidden_dim, hidden_dim, hidden_dim, num_layers, dropout) #.to(device)
        self.gcn2 = GCN(hidden_dim, hidden_dim, hidden_dim, num_layers, dropout) #.to(device)
...
model_gcn = HyperGCN(data.num_nodes, dropout=dropout, hidden_dim=hidden_channels).to(device)
